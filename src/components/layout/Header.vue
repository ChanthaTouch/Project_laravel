            ...
            <div class="relative bg-white flex w-full items-center px-5 py-2.5 dark:bg-[#0e1726]">
                ...
                >
                    <div class="sm:ltr:mr-auto sm:rtl:ml-auto">
                     ...
                     <div>
                        <button
                            class="flex items-center p-2 rounded-full bg-white-light/40 dark:bg-dark/40 hover:text-primary hover:bg-white-light/90 dark:hover:bg-dark/60 transition"
                            @click="toggleSwingTheme"
                            aria-label="Toggle dark/light mode"
                        >
                            <i v-if="store.theme === 'dark'" class="fas fa-moon w-5 h-5"></i>
                            ...
                            <template #content="{ close }">
                                <ul class="text-dark dark:text-white-dark !py-0 w-[230px] font-semibold dark:text-white-light/90">
                                    ...
                                    <li class="border-t border-white-light dark:border-white-light/10">
                                        <a href="javascript:;" class="text-danger !py-3" @click="handleSignOut">
