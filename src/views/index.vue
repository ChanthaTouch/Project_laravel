...
<script lang="ts" setup>
    ...
    console.log('Index page - Initial user store state:', {
    ...
    onMounted(() => {
        console.log('Index page - User store state on mount:', {
            isLoggedIn: userStore.isLoggedIn,
            user: userStore.getUser,
            token: userStore.getUser?.token
        });
    ...
    // Add a watcher for user store changes
    watch(() => userStore.isLoggedIn, (newValue) => {
        console.log('Index page - User login state changed:', {
            isLoggedIn: newValue,
            user: userStore.getUser,
            token: userStore.getUser?.token
        });
